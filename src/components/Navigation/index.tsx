                    ...
                    <>
                        <Box onClick={isOpen?handleClose:handleClick} sx={{display: 'flex',width:'20%',height:'100%', cursor:'pointer', ":hover":{bgcolor:'#f5f5f5'}, alignItems: 'center', justifyContent: 'space-around', }}>
                            <Box sx={{position:'relative'}} >
                                ...
                                {/* <h3 style={{fontSize: '15px', fontWeight:'bold', position:'absolute', top:-6,right:3 ,backgroundColor:'#fff'}}>{devices.reduce((acc,device)=>acc+device.notifications.length>0?acc+device.notifications.length:0,0)??0}</h3> */}
                            </Box>
