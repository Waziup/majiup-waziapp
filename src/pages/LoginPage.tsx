...
function LoginPage() {
    return (
        <Box>
            <Box sx={{}}>
                <Box sx={{margin: '0', padding: '30px', height: 50, boxSizing: 'border-box', display:'flex', bgcolor: '#ccc', justifyContent: 'space-between', alignItems:'center', width: '100%', color: 'white' }}>
                    <Box>
                ...
                <Box sx={{bgcolor: '#1A73E8',height: '100vh', textAlign: 'center', position: 'relative' }}>
                    <Box sx={{
                        ...
                        <Button sx={{color: 'black', bgcolor: 'white', width: '120px', borderRadius: '0', padding: '4px', marginTop: '10px'}} variant="contained">Login</Button>
